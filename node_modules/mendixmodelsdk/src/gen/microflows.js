...
(function (microflows) {
    ...
    AggregateFunctionEnum.All = new AggregateFunctionEnum("All", {
        introduced: "10.0.0"
    });
    AggregateFunctionEnum.Any = new AggregateFunctionEnum("Any", {
        introduced: "10.0.0"
    });
    AggregateFunctionEnum.Reduce = new AggregateFunctionEnum("Reduce", {
        introduced: "10.0.0"
    });
    ...
    class FlowLineType extends internal.AbstractEnum {
        constructor() {
            super(...arguments);
            this.qualifiedTsTypeName = "microflows.FlowLineType";
        }
    }
    FlowLineType.BezierCurve = new FlowLineType("BezierCurve", {});
    FlowLineType.Orthogonal = new FlowLineType("Orthogonal", {});
    microflows.FlowLineType = FlowLineType;
    ...
    class ProtocolType extends internal.AbstractEnum {
        constructor() {
            super(...arguments);
            this.qualifiedTsTypeName = "microflows.ProtocolType";
        }
    }
    ProtocolType.Unknown = new ProtocolType("Unknown", {});
    ProtocolType.SMTP = new ProtocolType("SMTP", {});
    microflows.ProtocolType = ProtocolType;
    ...
    class SecurityType extends internal.AbstractEnum {
        constructor() {
            super(...arguments);
            this.qualifiedTsTypeName = "microflows.SecurityType";
        }
    }
    SecurityType.None = new SecurityType("None", {});
    SecurityType.SSL = new SecurityType("SSL", {});
    SecurityType.TLS = new SecurityType("TLS", {});
    microflows.SecurityType = SecurityType;
     ...
     */
    class AdditionalAttribute extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__name = new internal.PrimitiveProperty(AdditionalAttribute, this, "name", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__type = new internal.PartProperty(AdditionalAttribute, this, "type", null, true);
            /** @internal */
            this.__value = new internal.PrimitiveProperty(AdditionalAttribute, this, "value", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__attribute = new internal.ByNameReferenceProperty(AdditionalAttribute, this, "attribute", null, "DomainModels$Attribute");
            /** @internal */
            this.__attributeDataType = new internal.PartProperty(AdditionalAttribute, this, "attributeDataType", null, true);
            if (arguments.length < 4) {
                throw new Error("new AdditionalAttribute() cannot be invoked directly, please use 'model.microflows.createAdditionalAttribute()'");
            }
        }
        get containerAsExternalActionParameterMapping() {
            return super.getContainerAs(ExternalActionParameterMapping);
        }
        get name() {
        ...
        get attributeDataType() {
            return this.__attributeDataType.get();
        }
        set attributeDataType(newValue) {
            this.__attributeDataType.set(newValue);
        }
        /**
         * Creates and returns a new AdditionalAttribute instance in the SDK and on the server.
         * The new AdditionalAttribute will be automatically stored in the 'additionalAttributes' property
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, AdditionalAttribute.structureTypeName, { start: "11.5.0" });
            return internal.instancehelpers.createElement(container, AdditionalAttribute, "additionalAttributes", true);
        }
        /**
         * Creates and returns a new AdditionalAttribute instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, AdditionalAttribute);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
            if (this.__attributeDataType.isAvailable) {
                this.attributeDataType = datatypes_1.datatypes.UnknownType.create(this.model);
            }
            this.type = datatypes_1.datatypes.UnknownType.create(this.model);
        }
    }
    AdditionalAttribute.structureTypeName = "Microflows$AdditionalAttribute";
    AdditionalAttribute.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.5.0",
        properties: {
            type: {
                required: {
    ...
    microflows.AdditionalAttribute = AdditionalAttribute;
    ...
    class AggregateListAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            ...
            /** @internal */
            this.__expression = new internal.PrimitiveProperty(AggregateListAction, this, "expression", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__useExpression = new internal.PrimitiveProperty(AggregateListAction, this, "useExpression", false, internal.PrimitiveTypeEnum.Boolean);
            /** @internal */
            ...
            /** @internal */
            this.__reduceReturnDataType = new internal.PartProperty(AggregateListAction, this, "reduceReturnDataType", null, true);
            /** @internal */
            this.__reduceInitialValueExpression = new internal.PrimitiveProperty(AggregateListAction, this, "reduceInitialValueExpression", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
         ...
         */
        get useExpression() {
            return this.__useExpression.get();
        }
        set useExpression(newValue) {
            this.__useExpression.set(newValue);
        }
         ...
         * In version 10.0.0: introduced
         */
        get reduceReturnDataType() {
            return this.__reduceReturnDataType.get();
        }
        set reduceReturnDataType(newValue) {
            this.__reduceReturnDataType.set(newValue);
        }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         *
         * In version 10.0.0: introduced
         */
        get reduceInitialValueExpression() {
            return this.__reduceInitialValueExpression.get();
        }
        set reduceInitialValueExpression(newValue) {
            this.__reduceInitialValueExpression.set(newValue);
        }
        /**
        ...
        _initializeDefaultProperties() {
            ...
            if (this.__reduceReturnDataType.isAvailable) {
                this.reduceReturnDataType = datatypes_1.datatypes.BooleanType.create(this.model);
            }
            if (this.__useExpression.isAvailable) {
     ...
     */
    class AuthenticationConfig extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__optForAuthDocument = new internal.PrimitiveProperty(AuthenticationConfig, this, "optForAuthDocument", false, internal.PrimitiveTypeEnum.Boolean);
            if (arguments.length < 4) {
                throw new Error("new AuthenticationConfig() cannot be invoked directly, please use 'model.microflows.createAuthenticationConfig()'");
            }
        }
        get containerAsSendEmailAction() {
            return super.getContainerAs(SendEmailAction);
        }
        get optForAuthDocument() {
            return this.__optForAuthDocument.get();
        }
        set optForAuthDocument(newValue) {
            this.__optForAuthDocument.set(newValue);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
            this.optForAuthDocument = false;
        }
    }
    AuthenticationConfig.structureTypeName = "Microflows$AuthenticationConfig";
    AuthenticationConfig.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.2.0"
    }, internal.StructureType.Element);
    microflows.AuthenticationConfig = AuthenticationConfig;
    /**
     * In version 11.5.0: introduced
     */
    class AuthenticationDocumentConfig extends AuthenticationConfig {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__authenticationDocument = new internal.ByNameReferenceProperty(AuthenticationDocumentConfig, this, "authenticationDocument", null, "Authentication$Authentication");
            if (arguments.length < 4) {
                throw new Error("new AuthenticationDocumentConfig() cannot be invoked directly, please use 'model.microflows.createAuthenticationDocumentConfig()'");
            }
        }
        get containerAsSendEmailAction() {
            return super.getContainerAs(SendEmailAction);
        }
        get authenticationDocument() {
            return this.__authenticationDocument.get();
        }
        set authenticationDocument(newValue) {
            this.__authenticationDocument.set(newValue);
        }
        get authenticationDocumentQualifiedName() {
            return this.__authenticationDocument.qualifiedName();
        }
        /**
         * Creates and returns a new AuthenticationDocumentConfig instance in the SDK and on the server.
         * The new AuthenticationDocumentConfig will be automatically stored in the 'emailAuthenticationConfig' property
         * of the parent SendEmailAction element passed as argument.
         *
         * Warning! Can only be used on models with the following Mendix meta model versions:
         *  11.5.0 and higher
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, AuthenticationDocumentConfig.structureTypeName, { start: "11.5.0" });
            return internal.instancehelpers.createElement(container, AuthenticationDocumentConfig, "emailAuthenticationConfig", false);
        }
        /**
         * Creates and returns a new AuthenticationDocumentConfig instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, AuthenticationDocumentConfig);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    AuthenticationDocumentConfig.structureTypeName = "Microflows$AuthenticationDocumentConfig";
    AuthenticationDocumentConfig.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.5.0"
    }, internal.StructureType.Element);
    microflows.AuthenticationDocumentConfig = AuthenticationDocumentConfig;
    /**
     * In version 11.2.0: introduced
     */
    class BasicAuthConfig extends AuthenticationConfig {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__username = new internal.PrimitiveProperty(BasicAuthConfig, this, "username", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__password = new internal.PrimitiveProperty(BasicAuthConfig, this, "password", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new BasicAuthConfig() cannot be invoked directly, please use 'model.microflows.createBasicAuthConfig()'");
            }
        }
        get containerAsSendEmailAction() {
            return super.getContainerAs(SendEmailAction);
        ...
        /**
         * Creates and returns a new BasicAuthConfig instance in the SDK and on the server.
         * The new BasicAuthConfig will be automatically stored in the 'emailAuthenticationConfig' property
         * of the parent SendEmailAction element passed as argument.
         *
         * Warning! Can only be used on models with the following Mendix meta model versions:
         *  11.2.0 and higher
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, BasicAuthConfig.structureTypeName, { start: "11.2.0" });
            return internal.instancehelpers.createElement(container, BasicAuthConfig, "emailAuthenticationConfig", false);
        }
        /**
         * Creates and returns a new BasicAuthConfig instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, BasicAuthConfig);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    BasicAuthConfig.structureTypeName = "Microflows$BasicAuthConfig";
    BasicAuthConfig.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.2.0"
    }, internal.StructureType.Element);
    microflows.BasicAuthConfig = BasicAuthConfig;
    /**
     ...
     */
    class BodyVariable extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__variableName = new internal.PrimitiveProperty(BodyVariable, this, "variableName", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new BodyVariable() cannot be invoked directly, please use 'model.microflows.createBodyVariable()'");
            }
        }
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, BodyVariable.structureTypeName, { start: "10.5.0" });
            return internal.instancehelpers.createElement(container, BodyVariable, "bodyVariable", false);
        }
        /**
         * Creates and returns a new BodyVariable instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, BodyVariable);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    BodyVariable.structureTypeName = "Microflows$BodyVariable";
    BodyVariable.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.5.0",
        experimental: {
            currentValue: false,
            changedIn: ["10.7.0"]
    ...
    microflows.BodyVariable = BodyVariable;
    /**
    ...
    class CallExternalAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            ...
            /** @internal */
            this.__parameterMappings = new internal.PartListProperty(CallExternalAction, this, "parameterMappings", []);
            /** @internal */
            this.__variableName = new internal.PrimitiveProperty(CallExternalAction, this, "variableName", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__variableDataType = new internal.PartProperty(CallExternalAction, this, "variableDataType", null, true);
            /** @internal */
            this.__includedAssociations = new internal.PartListProperty(CallExternalAction, this, "includedAssociations", []);
            if (arguments.length < 4) {
         ...
         */
        get includedAssociations() {
            return this.__includedAssociations.get();
        }
        /**
        ...
        _initializeDefaultProperties() {
            ...
            if (this.__variableDataType.isAvailable) {
                this.variableDataType = datatypes_1.datatypes.UnknownType.create(this.model);
            }
        }
    }
    ...
    /**
     * See: {@link https://docs.mendix.com/refguide/cancel-synchronization relevant section in reference guide}
     *
     * In version 11.8.0: introduced
     */
    class CancelSynchronizationAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            if (arguments.length < 4) {
                throw new Error("new CancelSynchronizationAction() cannot be invoked directly, please use 'model.microflows.createCancelSynchronizationAction()'");
            }
        }
        get containerAsActionActivity() {
            return super.getContainerAs(ActionActivity);
        ...
        /**
         * Creates and returns a new CancelSynchronizationAction instance in the SDK and on the server.
         * The new CancelSynchronizationAction will be automatically stored in the 'action' property
         * of the parent ActionActivity element passed as argument.
         *
         * Warning! Can only be used on models with the following Mendix meta model versions:
         *  11.8.0 and higher
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, CancelSynchronizationAction.structureTypeName, { start: "11.8.0" });
            return internal.instancehelpers.createElement(container, CancelSynchronizationAction, "action", false);
        }
        /**
         * Creates and returns a new CancelSynchronizationAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, CancelSynchronizationAction);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    CancelSynchronizationAction.structureTypeName = "Microflows$CancelSynchronizationAction";
    CancelSynchronizationAction.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.8.0"
    }, internal.StructureType.Element);
    microflows.CancelSynchronizationAction = CancelSynchronizationAction;
    ...
    class ClearFromClientAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__entity = new internal.ByNameReferenceProperty(ClearFromClientAction, this, "entity", null, "DomainModels$Entity");
            if (arguments.length < 4) {
                throw new Error("new ClearFromClientAction() cannot be invoked directly, please use 'model.microflows.createClearFromClientAction()'");
            }
        }
        get containerAsActionActivity() {
            return super.getContainerAs(ActionActivity);
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, ClearFromClientAction.structureTypeName, { start: "10.0.0" });
            return internal.instancehelpers.createElement(container, ClearFromClientAction, "action", false);
        }
        /**
         * Creates and returns a new ClearFromClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, ClearFromClientAction);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    ClearFromClientAction.structureTypeName = "Microflows$ClearFromClientAction";
    ClearFromClientAction.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.0.0"
    }, internal.StructureType.Element);
    microflows.ClearFromClientAction = ClearFromClientAction;
    /**
     ...
     * In version 11.6.0: introduced
     */
    class CustomBlobDocumentCodeActionParameterValue extends CodeActionParameterValue {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__customDocument = new internal.ByNameReferenceProperty(CustomBlobDocumentCodeActionParameterValue, this, "customDocument", null, "CustomBlobDocuments$CustomBlobDocument");
            if (arguments.length < 4) {
                throw new Error("new CustomBlobDocumentCodeActionParameterValue() cannot be invoked directly, please use 'model.microflows.createCustomBlobDocumentCodeActionParameterValue()'");
            }
        }
        get containerAsJavaActionParameterMapping() {
            return super.getContainerAs(JavaActionParameterMapping);
        ...
        get customDocument() {
            return this.__customDocument.get();
        }
        set customDocument(newValue) {
            this.__customDocument.set(newValue);
        }
        get customDocumentQualifiedName() {
            return this.__customDocument.qualifiedName();
        }
        /**
         * Creates and returns a new CustomBlobDocumentCodeActionParameterValue instance in the SDK and on the server.
         * The new CustomBlobDocumentCodeActionParameterValue will be automatically stored in the 'parameterValue' property
         * of the parent JavaActionParameterMapping element passed as argument.
         *
         * Warning! Can only be used on models with the following Mendix meta model versions:
         *  11.6.0 and higher
         */
        static createInJavaActionParameterMappingUnderParameterValue(container) {
            internal.createInVersionCheck(container.model, CustomBlobDocumentCodeActionParameterValue.structureTypeName, {
                start: "11.6.0"
            });
            return internal.instancehelpers.createElement(container, CustomBlobDocumentCodeActionParameterValue, "parameterValue", false);
        }
        /**
         * Creates and returns a new CustomBlobDocumentCodeActionParameterValue instance in the SDK and on the server.
         * The new CustomBlobDocumentCodeActionParameterValue will be automatically stored in the 'parameterValue' property
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, CustomBlobDocumentCodeActionParameterValue);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    CustomBlobDocumentCodeActionParameterValue.structureTypeName = "Microflows$CustomBlobDocumentCodeActionParameterValue";
    CustomBlobDocumentCodeActionParameterValue.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.6.0"
    }, internal.StructureType.Element);
    microflows.CustomBlobDocumentCodeActionParameterValue = CustomBlobDocumentCodeActionParameterValue;
     ...
     * In version 11.2.0: introduced
     */
    class EmailConnectionConfig extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__emailId = new internal.PrimitiveProperty(EmailConnectionConfig, this, "emailId", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__protocol = new internal.EnumProperty(EmailConnectionConfig, this, "protocol", ProtocolType.SMTP, ProtocolType);
            /** @internal */
            this.__host = new internal.PrimitiveProperty(EmailConnectionConfig, this, "host", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__port = new internal.PrimitiveProperty(EmailConnectionConfig, this, "port", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__securityType = new internal.EnumProperty(EmailConnectionConfig, this, "securityType", SecurityType.TLS, SecurityType);
            /** @internal */
            this.__checkServerIdentity = new internal.PrimitiveProperty(EmailConnectionConfig, this, "checkServerIdentity", false, internal.PrimitiveTypeEnum.Boolean);
            /** @internal */
            this.__connectionTimeout = new internal.PrimitiveProperty(EmailConnectionConfig, this, "connectionTimeout", 20000, internal.PrimitiveTypeEnum.Integer);
            if (arguments.length < 4) {
                throw new Error("new EmailConnectionConfig() cannot be invoked directly, please use 'model.microflows.createEmailConnectionConfig()'");
            }
        }
        get containerAsSendEmailAction() {
            return super.getContainerAs(SendEmailAction);
         ...
         */
        get emailId() {
            return this.__emailId.get();
        }
        set emailId(newValue) {
            this.__emailId.set(newValue);
        }
        get protocol() {
        ...
        get securityType() {
            return this.__securityType.get();
        }
        set securityType(newValue) {
            this.__securityType.set(newValue);
        }
        get checkServerIdentity() {
            return this.__checkServerIdentity.get();
        }
        set checkServerIdentity(newValue) {
            this.__checkServerIdentity.set(newValue);
        }
        get connectionTimeout() {
            return this.__connectionTimeout.get();
        }
        set connectionTimeout(newValue) {
            this.__connectionTimeout.set(newValue);
        }
        /**
         * Creates and returns a new EmailConnectionConfig instance in the SDK and on the server.
         * The new EmailConnectionConfig will be automatically stored in the 'emailConnectionConfig' property
         * of the parent SendEmailAction element passed as argument.
         *
         * Warning! Can only be used on models with the following Mendix meta model versions:
         *  11.2.0 and higher
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, EmailConnectionConfig.structureTypeName, { start: "11.2.0" });
            return internal.instancehelpers.createElement(container, EmailConnectionConfig, "emailConnectionConfig", false);
        }
        /**
         * Creates and returns a new EmailConnectionConfig instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, EmailConnectionConfig);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
            this.checkServerIdentity = false;
            this.connectionTimeout = 20000;
            this.protocol = ProtocolType.SMTP;
            this.securityType = SecurityType.TLS;
        }
    }
    EmailConnectionConfig.structureTypeName = "Microflows$EmailConnectionConfig";
    EmailConnectionConfig.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.2.0"
    }, internal.StructureType.Element);
    microflows.EmailConnectionConfig = EmailConnectionConfig;
    /**
     * In version 11.2.0: introduced
     */
    class EmailMessage extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__to = new internal.PrimitiveProperty(EmailMessage, this, "to", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__cc = new internal.PrimitiveProperty(EmailMessage, this, "cc", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__bcc = new internal.PrimitiveProperty(EmailMessage, this, "bcc", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__subject = new internal.PrimitiveProperty(EmailMessage, this, "subject", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__messageBodyPlainText = new internal.PrimitiveProperty(EmailMessage, this, "messageBodyPlainText", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__messageBodyHtml = new internal.PrimitiveProperty(EmailMessage, this, "messageBodyHtml", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__attachments = new internal.ByNameReferenceListProperty(EmailMessage, this, "attachments", [], "DomainModels$Entity");
            /** @internal */
            this.__attachment = new internal.PrimitiveProperty(EmailMessage, this, "attachment", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new EmailMessage() cannot be invoked directly, please use 'model.microflows.createEmailMessage()'");
            }
        }
        get containerAsSendEmailAction() {
            return super.getContainerAs(SendEmailAction);
         ...
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get messageBodyPlainText() {
            return this.__messageBodyPlainText.get();
        }
        set messageBodyPlainText(newValue) {
            this.__messageBodyPlainText.set(newValue);
        }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get messageBodyHtml() {
            return this.__messageBodyHtml.get();
        }
        set messageBodyHtml(newValue) {
            this.__messageBodyHtml.set(newValue);
        }
        /**
         * In version 11.3.0: deleted
         */
        get attachments() {
            return this.__attachments.get();
        }
        get attachmentsQualifiedNames() {
            return this.__attachments.qualifiedNames();
        }
        /**
         * In version 11.3.0: introduced
         */
        get attachment() {
        ...
        /**
         * Creates and returns a new EmailMessage instance in the SDK and on the server.
         * The new EmailMessage will be automatically stored in the 'emailMessage' property
         * of the parent SendEmailAction element passed as argument.
         *
         * Warning! Can only be used on models with the following Mendix meta model versions:
         *  11.2.0 and higher
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, EmailMessage.structureTypeName, { start: "11.2.0" });
            return internal.instancehelpers.createElement(container, EmailMessage, "emailMessage", false);
        }
        /**
         * Creates and returns a new EmailMessage instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, EmailMessage);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    EmailMessage.structureTypeName = "Microflows$EmailMessage";
    EmailMessage.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.2.0",
        properties: {
            attachments: {
                deleted: "11.3.0",
                deletionMessage: "Use attachment instead"
            },
            attachment: {
                introduced: "11.3.0"
            }
    ...
    microflows.EmailMessage = EmailMessage;
    /**
     ...
     * In version 10.2.0: introduced
     */
    class ExternalActionParameterMapping extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__parameterName = new internal.PrimitiveProperty(ExternalActionParameterMapping, this, "parameterName", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__parameterType = new internal.PartProperty(ExternalActionParameterMapping, this, "parameterType", null, true);
            /** @internal */
            this.__canBeEmpty = new internal.PrimitiveProperty(ExternalActionParameterMapping, this, "canBeEmpty", false, internal.PrimitiveTypeEnum.Boolean);
            /** @internal */
            this.__argument = new internal.PrimitiveProperty(ExternalActionParameterMapping, this, "argument", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__includedAssociations = new internal.PartListProperty(ExternalActionParameterMapping, this, "includedAssociations", []);
            /** @internal */
            this.__additionalAttributes = new internal.PartListProperty(ExternalActionParameterMapping, this, "additionalAttributes", []);
            if (arguments.length < 4) {
                throw new Error("new ExternalActionParameterMapping() cannot be invoked directly, please use 'model.microflows.createExternalActionParameterMapping()'");
            }
        }
        get containerAsCallExternalAction() {
            return super.getContainerAs(CallExternalAction);
        }
        get parameterName() {
        ...
        get additionalAttributes() {
            return this.__additionalAttributes.get();
        }
        /**
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, ExternalActionParameterMapping.structureTypeName, { start: "10.2.0" });
            return internal.instancehelpers.createElement(container, ExternalActionParameterMapping, "parameterMappings", true);
        }
        /**
         * Creates and returns a new ExternalActionParameterMapping instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, ExternalActionParameterMapping);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    ExternalActionParameterMapping.structureTypeName = "Microflows$ExternalActionParameterMapping";
    ExternalActionParameterMapping.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.2.0",
        properties: {
            parameterType: {
                required: {
    ...
    microflows.ExternalActionParameterMapping = ExternalActionParameterMapping;
    ...
    class GetWorkflowActivityRecordsAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__workflowVariable = new internal.PrimitiveProperty(GetWorkflowActivityRecordsAction, this, "workflowVariable", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__outputVariableName = new internal.PrimitiveProperty(GetWorkflowActivityRecordsAction, this, "outputVariableName", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new GetWorkflowActivityRecordsAction() cannot be invoked directly, please use 'model.microflows.createGetWorkflowActivityRecordsAction()'");
            }
        }
        get containerAsActionActivity() {
            return super.getContainerAs(ActionActivity);
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, GetWorkflowActivityRecordsAction.structureTypeName, { start: "10.4.0" });
            return internal.instancehelpers.createElement(container, GetWorkflowActivityRecordsAction, "action", false);
        }
        /**
         * Creates and returns a new GetWorkflowActivityRecordsAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, GetWorkflowActivityRecordsAction);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    GetWorkflowActivityRecordsAction.structureTypeName = "Microflows$GetWorkflowActivityRecordsAction";
    GetWorkflowActivityRecordsAction.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.4.0"
    }, internal.StructureType.Element);
    microflows.GetWorkflowActivityRecordsAction = GetWorkflowActivityRecordsAction;
    /**
    ...
    class GetWorkflowsAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__workflowContextVariableName = new internal.PrimitiveProperty(GetWorkflowsAction, this, "workflowContextVariableName", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__outputVariableName = new internal.PrimitiveProperty(GetWorkflowsAction, this, "outputVariableName", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new GetWorkflowsAction() cannot be invoked directly, please use 'model.microflows.createGetWorkflowsAction()'");
            }
        }
        get containerAsActionActivity() {
            return super.getContainerAs(ActionActivity);
        }
        get workflowContextVariableName() {
            return this.__workflowContextVariableName.get();
        }
        set workflowContextVariableName(newValue) {
            this.__workflowContextVariableName.set(newValue);
        }
        get outputVariableName() {
            return this.__outputVariableName.get();
        }
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, GetWorkflowsAction.structureTypeName, { start: "10.4.0" });
            return internal.instancehelpers.createElement(container, GetWorkflowsAction, "action", false);
        }
        /**
         * Creates and returns a new GetWorkflowsAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, GetWorkflowsAction);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    GetWorkflowsAction.structureTypeName = "Microflows$GetWorkflowsAction";
    GetWorkflowsAction.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.4.0"
    }, internal.StructureType.Element);
    microflows.GetWorkflowsAction = GetWorkflowsAction;
     ...
     * In version 10.11.0: introduced
     */
    class IncludedAssociation extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__association = new internal.ByNameReferenceProperty(IncludedAssociation, this, "association", null, "DomainModels$AssociationBase");
            /** @internal */
            this.__isParent = new internal.PrimitiveProperty(IncludedAssociation, this, "isParent", false, internal.PrimitiveTypeEnum.Boolean);
            /** @internal */
            this.__includedAssociations = new internal.PartListProperty(IncludedAssociation, this, "includedAssociations", []);
            if (arguments.length < 4) {
                throw new Error("new IncludedAssociation() cannot be invoked directly, please use 'model.microflows.createIncludedAssociation()'");
            }
        }
        get containerAsCallExternalAction() {
            return super.getContainerAs(CallExternalAction);
        ...
        get containerAsIncludedAssociation() {
            return super.getContainerAs(IncludedAssociation);
        }
        get association() {
            return this.__association.get();
        }
        ...
        get isParent() {
            return this.__isParent.get();
        }
        set isParent(newValue) {
            this.__isParent.set(newValue);
        }
        get includedAssociations() {
            return this.__includedAssociations.get();
        }
         ...
         *  10.12.0 and higher
         */
        static createInCallExternalActionUnderIncludedAssociations(container) {
            internal.createInVersionCheck(container.model, IncludedAssociation.structureTypeName, { start: "10.12.0" });
            return internal.instancehelpers.createElement(container, IncludedAssociation, "includedAssociations", true);
        }
        /**
         * Creates and returns a new IncludedAssociation instance in the SDK and on the server.
         * The new IncludedAssociation will be automatically stored in the 'includedAssociations' property
         ...
         *  10.11.0 and higher
         */
        static createInExternalActionParameterMappingUnderIncludedAssociations(container) {
            internal.createInVersionCheck(container.model, IncludedAssociation.structureTypeName, { start: "10.11.0" });
            return internal.instancehelpers.createElement(container, IncludedAssociation, "includedAssociations", true);
        }
        /**
         * Creates and returns a new IncludedAssociation instance in the SDK and on the server.
         ...
         *  10.11.0 and higher
         */
        static createInIncludedAssociationUnderIncludedAssociations(container) {
            internal.createInVersionCheck(container.model, IncludedAssociation.structureTypeName, { start: "10.11.0" });
            return internal.instancehelpers.createElement(container, IncludedAssociation, "includedAssociations", true);
        }
        /**
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, IncludedAssociation);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    IncludedAssociation.structureTypeName = "Microflows$IncludedAssociation";
    IncludedAssociation.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.11.0",
        properties: {
            association: {
                required: {
    ...
    microflows.IncludedAssociation = IncludedAssociation;
    /**
    ...
    class LockWorkflowAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            ...
            /** @internal */
            this.__workflowSelection = new internal.PartProperty(LockWorkflowAction, this, "workflowSelection", null, false);
            /** @internal */
         ...
         * In version 10.0.0: introduced
         */
        get workflowSelection() {
            return this.__workflowSelection.get();
        }
        set workflowSelection(newValue) {
            this.__workflowSelection.set(newValue);
        }
    ...
    class MicroflowBase extends projects_1.projects.Document {
        constructor(model, structureTypeName, id, isPartial, container) {
            ...
            /** @internal */
            this.__returnVariableName = new internal.PrimitiveProperty(MicroflowBase, this, "returnVariableName", "", internal.PrimitiveTypeEnum.String);
        }
        ...
        get returnVariableName() {
            return this.__returnVariableName.get();
        }
        set returnVariableName(newValue) {
            this.__returnVariableName.set(newValue);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    class Microflow extends ServerSideMicroflow {
        constructor(model, structureTypeName, id, isPartial, container) {
            ...
            /** @internal */
            this.__url = new internal.PrimitiveProperty(Microflow, this, "url", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__urlSearchParameters = new internal.ByNameReferenceListProperty(Microflow, this, "urlSearchParameters", [], "Microflows$MicroflowParameter");
            /** @internal */
            this.__stableId = new internal.PrimitiveProperty(Microflow, this, "stableId", "", internal.PrimitiveTypeEnum.Guid);
        ...
        get urlSearchParameters() {
            return this.__urlSearchParameters.get();
        }
        get urlSearchParametersQualifiedNames() {
            return this.__urlSearchParameters.qualifiedNames();
        }
        /**
         * In version 10.2.0: introduced
         */
        get stableId() {
            return this.__stableId.get();
        }
        set stableId(newValue) {
            this.__stableId.set(newValue);
        }
        /**
        ...
        _initializeDefaultProperties() {
            ...
            if (this.__stableId.isAvailable) {
                this.stableId = utils_1.utils.randomUuid();
            }
        }
    }
     ...
     * In version 10.1.0: introduced
     */
    class MicroflowParameterAttributeUrlSegment extends url_1.url.UrlSegment {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__microflowParameter = new internal.LocalByNameReferenceProperty(MicroflowParameterAttributeUrlSegment, this, "microflowParameter", null, "Microflows$MicroflowParameter");
            /** @internal */
            this.__attribute = new internal.ByNameReferenceProperty(MicroflowParameterAttributeUrlSegment, this, "attribute", null, "DomainModels$Attribute");
            if (arguments.length < 4) {
                throw new Error("new MicroflowParameterAttributeUrlSegment() cannot be invoked directly, please use 'model.microflows.createMicroflowParameterAttributeUrlSegment()'");
            }
        }
        ...
        get microflowParameterLocalName() {
            return this.__microflowParameter.localName();
        }
        get attribute() {
            return this.__attribute.get();
        }
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, MicroflowParameterAttributeUrlSegment);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    MicroflowParameterAttributeUrlSegment.structureTypeName = "Microflows$MicroflowParameterAttributeUrlSegment";
    MicroflowParameterAttributeUrlSegment.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.1.0",
        properties: {
            microflowParameter: {
                required: {
    ...
    microflows.MicroflowParameterAttributeUrlSegment = MicroflowParameterAttributeUrlSegment;
     ...
     */
    class MicroflowPrimitiveParameterUrlSegment extends url_1.url.UrlSegment {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__microflowParameter = new internal.LocalByNameReferenceProperty(MicroflowPrimitiveParameterUrlSegment, this, "microflowParameter", null, "Microflows$MicroflowParameter");
            if (arguments.length < 4) {
                throw new Error("new MicroflowPrimitiveParameterUrlSegment() cannot be invoked directly, please use 'model.microflows.createMicroflowPrimitiveParameterUrlSegment()'");
            }
        }
        get microflowParameter() {
            return this.__microflowParameter.get();
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, MicroflowPrimitiveParameterUrlSegment);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    MicroflowPrimitiveParameterUrlSegment.structureTypeName = "Microflows$MicroflowPrimitiveParameterUrlSegment";
    MicroflowPrimitiveParameterUrlSegment.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.3.0",
        properties: {
            microflowParameter: {
                required: {
    ...
    microflows.MicroflowPrimitiveParameterUrlSegment = MicroflowPrimitiveParameterUrlSegment;
    /**
    ...
    class Nanoflow extends MicroflowBase {
        constructor(model, structureTypeName, id, isPartial, container) {
            ...
            /** @internal */
            this.__useListParameterByReference = new internal.PrimitiveProperty(Nanoflow, this, "useListParameterByReference", true, internal.PrimitiveTypeEnum.Boolean);
            this._containmentName = "documents";
        }
        get containerAsFolderBase() {
            return super.getContainerAs(projects_1.projects.FolderBase);
         ...
         */
        get useListParameterByReference() {
            return this.__useListParameterByReference.get();
        }
        set useListParameterByReference(newValue) {
            this.__useListParameterByReference.set(newValue);
        }
        /**
        ...
        _initializeDefaultProperties() {
            ...
            if (this.__useListParameterByReference.isAvailable) {
                this.useListParameterByReference = true;
            }
        }
    }
    ...
    class NotifyWorkflowAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__workflowVariable = new internal.PrimitiveProperty(NotifyWorkflowAction, this, "workflowVariable", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__activity = new internal.ByNameReferenceProperty(NotifyWorkflowAction, this, "activity", null, "Workflows$WaitForNotificationActivity");
            /** @internal */
            this.__notifyTarget = new internal.PartProperty(NotifyWorkflowAction, this, "notifyTarget", null, false);
            /** @internal */
            this.__outputVariableName = new internal.PrimitiveProperty(NotifyWorkflowAction, this, "outputVariableName", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new NotifyWorkflowAction() cannot be invoked directly, please use 'model.microflows.createNotifyWorkflowAction()'");
            }
        }
        get containerAsActionActivity() {
            return super.getContainerAs(ActionActivity);
         ...
         */
        get notifyTarget() {
            return this.__notifyTarget.get();
        }
        set notifyTarget(newValue) {
            this.__notifyTarget.set(newValue);
        }
        get outputVariableName() {
            return this.__outputVariableName.get();
        }
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, NotifyWorkflowAction.structureTypeName, { start: "10.0.0" });
            return internal.instancehelpers.createElement(container, NotifyWorkflowAction, "action", false);
        }
        /**
         * Creates and returns a new NotifyWorkflowAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, NotifyWorkflowAction);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    NotifyWorkflowAction.structureTypeName = "Microflows$NotifyWorkflowAction";
    NotifyWorkflowAction.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.0.0",
        properties: {
            activity: {
                deleted: "11.7.0",
    ...
    microflows.NotifyWorkflowAction = NotifyWorkflowAction;
    /**
     ...
     * In version 10.4.0: introduced
     */
    class OutputVariable extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__variableName = new internal.PrimitiveProperty(OutputVariable, this, "variableName", "Variable", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new OutputVariable() cannot be invoked directly, please use 'model.microflows.createOutputVariable()'");
            }
        }
        get containerAsRestOperationCallAction() {
            return super.getContainerAs(RestOperationCallAction);
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, OutputVariable.structureTypeName, { start: "10.4.0" });
            return internal.instancehelpers.createElement(container, OutputVariable, "outputVariable", false);
        }
        /**
         * Creates and returns a new OutputVariable instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, OutputVariable);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    OutputVariable.structureTypeName = "Microflows$OutputVariable";
    OutputVariable.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.4.0",
        experimental: {
            currentValue: false,
            changedIn: ["10.7.0"]
    ...
    microflows.OutputVariable = OutputVariable;
    /**
     * In version 10.1.0: introduced
     */
    class ParameterIdUrlSegment extends url_1.url.UrlSegment {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__microflowParameter = new internal.LocalByNameReferenceProperty(ParameterIdUrlSegment, this, "microflowParameter", null, "Microflows$MicroflowParameter");
            if (arguments.length < 4) {
                throw new Error("new ParameterIdUrlSegment() cannot be invoked directly, please use 'model.microflows.createParameterIdUrlSegment()'");
            }
        }
        get microflowParameter() {
            return this.__microflowParameter.get();
    ...
    ParameterIdUrlSegment.structureTypeName = "Microflows$ParameterIdUrlSegment";
    ...
    microflows.ParameterIdUrlSegment = ParameterIdUrlSegment;
    /**
     * In version 9.12.0: removed experimental
     * In version 9.3.0: introduced
     */
    ...
    class RestOperationCallAction extends MicroflowAction {
         ...
         */
        get bodyVariable() {
            return this.__bodyVariable.get();
        }
        set bodyVariable(newValue) {
            this.__bodyVariable.set(newValue);
        }
        /**
         * In version 10.2.0: introduced
         */
         ...
         */
        get outputVariable() {
            return this.__outputVariable.get();
        }
        set outputVariable(newValue) {
            this.__outputVariable.set(newValue);
        }
        /**
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, RestOperationCallAction.structureTypeName, { start: "10.1.0" });
     ...
     * In version 10.2.0: introduced
     */
    class RestOperationParameterMapping extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__parameter = new internal.ByNameReferenceProperty(RestOperationParameterMapping, this, "parameter", null, "Rest$OperationParameter");
            /** @internal */
            this.__value = new internal.PrimitiveProperty(RestOperationParameterMapping, this, "value", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new RestOperationParameterMapping() cannot be invoked directly, please use 'model.microflows.createRestOperationParameterMapping()'");
            }
        }
        get containerAsRestOperationCallAction() {
            return super.getContainerAs(RestOperationCallAction);
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, RestOperationParameterMapping.structureTypeName, { start: "10.2.0" });
            return internal.instancehelpers.createElement(container, RestOperationParameterMapping, "parameterMappings", true);
        }
        /**
         * Creates and returns a new RestOperationParameterMapping instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, RestOperationParameterMapping);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    RestOperationParameterMapping.structureTypeName = "Microflows$RestOperationParameterMapping";
    RestOperationParameterMapping.versionInfo = new exports.StructureVersionInfo({
        introduced: "10.2.0",
        properties: {
            parameter: {
                required: {
    ...
    /**
     * See: {@link https://docs.mendix.com/refguide/sendemail-action relevant section in reference guide}
     *
     * In version 11.2.0: introduced
     */
    class SendEmailAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__emailAuthenticationConfig = new internal.PartProperty(SendEmailAction, this, "emailAuthenticationConfig", null, false);
            /** @internal */
            this.__emailConnectionConfig = new internal.PartProperty(SendEmailAction, this, "emailConnectionConfig", null, true);
            /** @internal */
            this.__emailMessage = new internal.PartProperty(SendEmailAction, this, "emailMessage", null, true);
            if (arguments.length < 4) {
                throw new Error("new SendEmailAction() cannot be invoked directly, please use 'model.microflows.createSendEmailAction()'");
            }
        }
        get containerAsActionActivity() {
            return super.getContainerAs(ActionActivity);
        }
        get emailAuthenticationConfig() {
            return this.__emailAuthenticationConfig.get();
        }
        set emailAuthenticationConfig(newValue) {
            this.__emailAuthenticationConfig.set(newValue);
        }
        get emailConnectionConfig() {
            return this.__emailConnectionConfig.get();
        }
        set emailConnectionConfig(newValue) {
            this.__emailConnectionConfig.set(newValue);
        }
        get emailMessage() {
            return this.__emailMessage.get();
        }
        set emailMessage(newValue) {
            this.__emailMessage.set(newValue);
        }
        /**
         * Creates and returns a new SendEmailAction instance in the SDK and on the server.
         * The new SendEmailAction will be automatically stored in the 'action' property
         * of the parent ActionActivity element passed as argument.
         *
         * Warning! Can only be used on models with the following Mendix meta model versions:
         *  11.2.0 and higher
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, SendEmailAction.structureTypeName, { start: "11.2.0" });
            return internal.instancehelpers.createElement(container, SendEmailAction, "action", false);
        }
        /**
         * Creates and returns a new SendEmailAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, SendEmailAction);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
            this.emailConnectionConfig = EmailConnectionConfig.create(this.model);
            this.emailMessage = EmailMessage.create(this.model);
        }
    }
    SendEmailAction.structureTypeName = "Microflows$SendEmailAction";
    SendEmailAction.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.2.0",
        properties: {
    ...
    microflows.SendEmailAction = SendEmailAction;
    /**
    ...
    class Template extends internal.Element {
        ...
        get containerAsUserTaskActivity() {
            return super.getContainerAs(workflows_1.workflows.UserTaskActivity);
        }
    ...
    class StringTemplate extends Template {
        ...
        static createInUserTaskUnderTaskDescription(container) {
            internal.createInVersionCheck(container.model, StringTemplate.structureTypeName, { start: "9.0.2", end: "10.11.0" });
         ...
         *  10.12.0 and higher
         */
        static createInUserTaskActivityUnderTaskDescription(container) {
            internal.createInVersionCheck(container.model, StringTemplate.structureTypeName, { start: "10.12.0" });
            return internal.instancehelpers.createElement(container, StringTemplate, "taskDescription", false);
        }
        /**
         * Creates and returns a new StringTemplate instance in the SDK and on the server.
         ...
         *  10.12.0 and higher
         */
        static createInUserTaskActivityUnderTaskName(container) {
            internal.createInVersionCheck(container.model, StringTemplate.structureTypeName, { start: "10.12.0" });
            return internal.instancehelpers.createElement(container, StringTemplate, "taskName", false);
        }
        /**
    ...
    /**
     * See: {@link https://docs.mendix.com/refguide/data-transformer/#transform-json-action relevant section in reference guide}
     *
     * In version 11.8.0: removed experimental
     * In version 11.4.0: introduced
     */
    class TransformJsonAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__transformation = new internal.ByNameReferenceProperty(TransformJsonAction, this, "transformation", null, "DataTransformers$DataTransformer");
            /** @internal */
            this.__inputVariableName = new internal.PrimitiveProperty(TransformJsonAction, this, "inputVariableName", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__outputVariableName = new internal.PrimitiveProperty(TransformJsonAction, this, "outputVariableName", "", internal.PrimitiveTypeEnum.String);
            if (arguments.length < 4) {
                throw new Error("new TransformJsonAction() cannot be invoked directly, please use 'model.microflows.createTransformJsonAction()'");
            }
        }
        get containerAsActionActivity() {
            return super.getContainerAs(ActionActivity);
        ...
        /**
         * In version 11.9.0: added optional
         */
        get transformation() {
            return this.__transformation.get();
        }
        set transformation(newValue) {
            this.__transformation.set(newValue);
        }
        get transformationQualifiedName() {
            return this.__transformation.qualifiedName();
        }
        get inputVariableName() {
            return this.__inputVariableName.get();
        }
        ...
        /**
         * Creates and returns a new TransformJsonAction instance in the SDK and on the server.
         * The new TransformJsonAction will be automatically stored in the 'action' property
         * of the parent ActionActivity element passed as argument.
         *
         * Warning! Can only be used on models with the following Mendix meta model versions:
         *  11.4.0 and higher
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, TransformJsonAction.structureTypeName, { start: "11.4.0" });
            return internal.instancehelpers.createElement(container, TransformJsonAction, "action", false);
        }
        /**
         * Creates and returns a new TransformJsonAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, TransformJsonAction);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    TransformJsonAction.structureTypeName = "Microflows$TransformJsonAction";
    TransformJsonAction.versionInfo = new exports.StructureVersionInfo({
        introduced: "11.4.0",
        properties: {
            transformation: {
                required: {
    ...
    microflows.TransformJsonAction = TransformJsonAction;
    /**
     * In version 8.6.0: introduced
     */
    ...
    class UnlockWorkflowAction extends MicroflowAction {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            ...
            /** @internal */
            this.__workflowSelection = new internal.PartProperty(UnlockWorkflowAction, this, "workflowSelection", null, false);
            /** @internal */

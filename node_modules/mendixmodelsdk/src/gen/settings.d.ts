...
export declare namespace settings {
    ...
    class RuntimeSettings extends ProjectSettingsPart {
         ...
         */
        get decimalScale(): number;
        set decimalScale(newValue: number);
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
        /**
    ...
    class WebUIProjectSettingsPart extends ProjectSettingsPart {
         ...
         */
        get enableNewStringBehavior(): boolean;
        set enableNewStringBehavior(newValue: boolean);
        /**
         * In version 11.8.0: introduced
         */
        get exportEmbeddedEntrypoint(): boolean;
        set exportEmbeddedEntrypoint(newValue: boolean);
        /**
         * In version 11.9.0: introduced
         */
        get enableRspackBundler(): boolean;
        set enableRspackBundler(newValue: boolean);
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
        /**
     ...
     */
    class WorkflowGroup extends internal.Element<IModel> {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsWorkflowsProjectSettingsPart(): WorkflowsProjectSettingsPart;
        get name(): string;
        set name(newValue: string);
         ...
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): WorkflowGroup;
    }
    /**
    ...
    class WorkflowsProjectSettingsPart extends ProjectSettingsPart {
         ...
         * In version 11.2.0: introduced
         */
        get groups(): internal.IList<WorkflowGroup> | null;
        /**

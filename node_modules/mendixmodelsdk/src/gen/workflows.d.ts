...
export declare namespace workflows {
    ...
    class ConnectionSide extends internal.AbstractEnum {
        static Top: ConnectionSide;
        static Bottom: ConnectionSide;
        static Left: ConnectionSide;
        static Right: ConnectionSide;
        protected qualifiedTsTypeName: string;
    }
    class WorkflowEventType extends internal.AbstractEnum {
        ...
        static AIAgentTaskStarted: WorkflowEventType;
        static AIAgentTaskEnded: WorkflowEventType;
        ...
        static NonInterruptingNotificationEventSubProcessStartExecuted: WorkflowEventType;
        protected qualifiedTsTypeName: string;
    }
    /**
    ...
    abstract class WorkflowActivity extends internal.Element<IModel> implements IWorkflowActivity {
        ...
        get containerAsWorkflowMetaData(): WorkflowMetaData;
        /**
     ...
     */
    interface IMicroflowBasedActivity extends IConditionOutcomeActivity {
        readonly model: IModel;
        readonly containerAsFlow: IFlow;
        ...
        asLoaded(): MicroflowBasedActivity;
        load(callback: (element: MicroflowBasedActivity) => void, forceRefresh?: boolean): void;
        load(forceRefresh?: boolean): Promise<MicroflowBasedActivity>;
    }
    /**
     * In version 11.9.0: introduced
     */
    abstract class MicroflowBasedActivity extends ConditionOutcomeActivity implements IMicroflowBasedActivity {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsFlow(): Flow;
        get containerAsWorkflowMetaData(): WorkflowMetaData;
     ...
     * In version 11.9.0: introduced
     */
    interface IAIAgentTaskActivity extends IMicroflowBasedActivity {
        readonly model: IModel;
        readonly containerAsFlow: IFlow;
        asLoaded(): AIAgentTaskActivity;
        load(callback: (element: AIAgentTaskActivity) => void, forceRefresh?: boolean): void;
        load(forceRefresh?: boolean): Promise<AIAgentTaskActivity>;
    }
    /**
     * See: {@link https://docs.mendix.com/refguide/ai-agent-task relevant section in reference guide}
     *
     * In version 11.9.0: introduced
     */
    class AIAgentTaskActivity extends MicroflowBasedActivity implements IAIAgentTaskActivity {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsFlow(): Flow;
        get containerAsWorkflowMetaData(): WorkflowMetaData;
         ...
         *  11.9.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): AIAgentTaskActivity;
        /**
         * Creates and returns a new AIAgentTaskActivity instance in the SDK and on the server.
         ...
         *  11.9.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): AIAgentTaskActivity;
        /**
         * Creates and returns a new AIAgentTaskActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): AIAgentTaskActivity;
    }
    /**
    ...
    class Annotation extends internal.Element<IModel> {
        ...
        get containerAsEventSubProcess(): EventSubProcess;
         ...
         *  11.8.0 and higher
         */
        static createInEventSubProcessUnderAnnotation(container: EventSubProcess): Annotation;
        /**
         * Creates and returns a new Annotation instance in the SDK and on the server.
         * The new Annotation will be automatically stored in the 'annotation' property
    ...
    abstract class Line extends internal.Element<IModel> {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsFlowLine(): FlowLine;
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
    }
    /**
     * In version 11.1.0: introduced
    ...
    class BezierCurve extends Line {
         ...
         *  11.1.0 and higher
         */
        static createIn(container: FlowLine): BezierCurve;
        /**
         * Creates and returns a new BezierCurve instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class BooleanCase extends CaseValue {
         ...
         *  11.5.0 and higher
         */
        static createIn(container: FlowLine): BooleanCase;
        /**
         * Creates and returns a new BooleanCase instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): BooleanCase;
    }
    /**
     * See: {@link https://docs.mendix.com/refguide/workflows relevant section in reference guide}
     *
    ...
    interface IBoundaryEvent extends internal.IElement {
        ...
        readonly containerAsMicroflowBasedActivity: IMicroflowBasedActivity;
        readonly containerAsUserTaskActivity: IUserTaskActivity;
    ...
    abstract class BoundaryEvent extends internal.Element<IModel> implements IBoundaryEvent {
        ...
        get containerAsMicroflowBasedActivity(): MicroflowBasedActivity;
        get containerAsUserTaskActivity(): UserTaskActivity;
     ...
     * In version 11.9.0: introduced
     */
    interface ICallMicroflowActivity extends IMicroflowBasedActivity {
        readonly model: IModel;
        readonly containerAsFlow: IFlow;
        asLoaded(): CallMicroflowActivity;
        load(callback: (element: CallMicroflowActivity) => void, forceRefresh?: boolean): void;
        load(forceRefresh?: boolean): Promise<CallMicroflowActivity>;
    }
    /**
     * See: {@link https://docs.mendix.com/refguide/call-microflow relevant section in reference guide}
     *
     * In version 11.9.0: introduced
     */
    class CallMicroflowActivity extends MicroflowBasedActivity implements ICallMicroflowActivity {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsFlow(): Flow;
        get containerAsWorkflowMetaData(): WorkflowMetaData;
         ...
         *  11.9.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): CallMicroflowActivity;
        /**
         * Creates and returns a new CallMicroflowActivity instance in the SDK and on the server.
         ...
         *  11.9.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): CallMicroflowActivity;
        /**
         * Creates and returns a new CallMicroflowActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): CallMicroflowActivity;
    }
    /**
    ...
    class CallMicroflowTask extends ConditionOutcomeActivity implements ICallMicroflowTask {
         ...
         *  9.0.2 to 11.8.0
         */
        static createInFlowUnderActivities(container: Flow): CallMicroflowTask;
        /**
         * Creates and returns a new CallMicroflowTask instance in the SDK and on the server.
         ...
         *  11.1.0 to 11.8.0
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): CallMicroflowTask;
        /**
         * Creates and returns a new CallMicroflowTask instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class CallWorkflowActivity extends WorkflowActivity implements ICallWorkflowActivity {
         ...
         *  9.0.2 and higher
         */
        static createInFlowUnderActivities(container: Flow): CallWorkflowActivity;
        /**
         * Creates and returns a new CallWorkflowActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): CallWorkflowActivity;
        /**
         * Creates and returns a new CallWorkflowActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class EndOfBoundaryEventPathActivity extends WorkflowActivity implements IEndOfBoundaryEventPathActivity {
         ...
         *  10.14.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): EndOfBoundaryEventPathActivity;
        /**
         * Creates and returns a new EndOfBoundaryEventPathActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): EndOfBoundaryEventPathActivity;
        /**
         * Creates and returns a new EndOfBoundaryEventPathActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class EndOfParallelSplitPathActivity extends WorkflowActivity implements IEndOfParallelSplitPathActivity {
         ...
         *  10.21.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): EndOfParallelSplitPathActivity;
        /**
         * Creates and returns a new EndOfParallelSplitPathActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): EndOfParallelSplitPathActivity;
        /**
         * Creates and returns a new EndOfParallelSplitPathActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class EndWorkflowActivity extends WorkflowActivity implements IEndWorkflowActivity {
         ...
         *  9.0.2 and higher
         */
        static createInFlowUnderActivities(container: Flow): EndWorkflowActivity;
        /**
         * Creates and returns a new EndWorkflowActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): EndWorkflowActivity;
        /**
         * Creates and returns a new EndWorkflowActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
     ...
     */
    interface IEventSubProcess extends internal.IElement, internal.IByNameReferrable {
        readonly model: IModel;
        ...
        readonly flow: IFlow;
        readonly caption: string;
        asLoaded(): EventSubProcess;
        load(callback: (element: EventSubProcess) => void, forceRefresh?: boolean): void;
        load(forceRefresh?: boolean): Promise<EventSubProcess>;
    }
    /**
     * See: {@link https://docs.mendix.com/refguide/workflow-event-sub-processes relevant section in reference guide}
     *
     * In version 11.8.0: introduced
     */
    class EventSubProcess extends internal.Element<IModel> implements IEventSubProcess {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsWorkflow(): Workflow;
        get persistentId(): string;
         ...
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): EventSubProcess;
        get qualifiedName(): string | null;
    }
    /**
    ...
    class ExclusiveSplitActivity extends ConditionOutcomeActivity implements IExclusiveSplitActivity {
         ...
         *  9.0.2 and higher
         */
        static createInFlowUnderActivities(container: Flow): ExclusiveSplitActivity;
        /**
         * Creates and returns a new ExclusiveSplitActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): ExclusiveSplitActivity;
        /**
         * Creates and returns a new ExclusiveSplitActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
     ...
     * In version 11.1.0: introduced
     */
    class FloatingAnnotation extends internal.Element<IModel> {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsWorkflowMetaData(): WorkflowMetaData;
        get description(): string;
         ...
         *  11.1.0 and higher
         */
        static createIn(container: WorkflowMetaData): FloatingAnnotation;
        /**
         * Creates and returns a new FloatingAnnotation instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): FloatingAnnotation;
    }
    /**
     * In version 9.0.5: removed experimental
     * In version 9.0.2: introduced
    ...
    interface IFlow extends internal.IElement {
        ...
        readonly containerAsEventSubProcess: IEventSubProcess;
    ...
    class Flow extends internal.Element<IModel> implements IFlow {
         ...
         *  11.8.0 and higher
         */
        static createInEventSubProcessUnderFlow(container: EventSubProcess): Flow;
        /**
         * Creates and returns a new Flow instance in the SDK and on the server.
         * The new Flow will be automatically stored in the 'flow' property
     ...
     * In version 11.1.0: introduced
     */
    class FlowLine extends internal.Element<IModel> {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsWorkflowMetaData(): WorkflowMetaData;
        get origin(): WorkflowActivity;
        set origin(newValue: WorkflowActivity);
        get destination(): WorkflowActivity;
        set destination(newValue: WorkflowActivity);
        get line(): Line;
        set line(newValue: Line);
        get originConnectionSide(): ConnectionSide;
        set originConnectionSide(newValue: ConnectionSide);
        get originalConnectionFactor(): number;
        set originalConnectionFactor(newValue: number);
        get destinationConnectionSide(): ConnectionSide;
        set destinationConnectionSide(newValue: ConnectionSide);
        get destinationConnectionFactor(): number;
        set destinationConnectionFactor(newValue: number);
        /**
         * In version 11.5.0: introduced
         */
         ...
         *  11.1.0 and higher
         */
        static createIn(container: WorkflowMetaData): FlowLine;
        /**
         * Creates and returns a new FlowLine instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): FlowLine;
    }
    /**
    ...
    class InterruptingTimerBoundaryEvent extends BoundaryEvent implements IInterruptingTimerBoundaryEvent {
         ...
         *  11.9.0 and higher
         */
        static createInMicroflowBasedActivityUnderBoundaryEvents(container: MicroflowBasedActivity): InterruptingTimerBoundaryEvent;
        /**
         * Creates and returns a new InterruptingTimerBoundaryEvent instance in the SDK and on the server.
         * The new InterruptingTimerBoundaryEvent will be automatically stored in the 'boundaryEvents' property
         * of the parent UserTaskActivity element passed as argument.
    ...
    class JumpToActivity extends WorkflowActivity implements IJumpToActivity {
         ...
         *  9.0.5 and higher
         */
        static createInFlowUnderActivities(container: Flow): JumpToActivity;
        /**
         * Creates and returns a new JumpToActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): JumpToActivity;
        /**
         * Creates and returns a new JumpToActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
     ...
     * In version 11.5.0: introduced
     */
    interface IMergeActivity extends IWorkflowActivity {
        readonly model: IModel;
        readonly containerAsFlow: IFlow;
        asLoaded(): MergeActivity;
        load(callback: (element: MergeActivity) => void, forceRefresh?: boolean): void;
        load(forceRefresh?: boolean): Promise<MergeActivity>;
    }
    /**
     * In version 11.5.0: introduced
     */
    class MergeActivity extends WorkflowActivity implements IMergeActivity {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsFlow(): Flow;
        get containerAsWorkflowMetaData(): WorkflowMetaData;
         ...
         *  11.5.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): MergeActivity;
        /**
         * Creates and returns a new MergeActivity instance in the SDK and on the server.
         ...
         *  11.5.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): MergeActivity;
        /**
         * Creates and returns a new MergeActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): MergeActivity;
    }
    /**
     * In version 9.0.5: introduced
     */
     ...
     */
    abstract class UserTargeting extends internal.Element<IModel> {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsUserTaskActivity(): UserTaskActivity;
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
     ...
     * In version 11.2.0: introduced
     */
    abstract class MicroflowBasedTargeting extends UserTargeting {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsUserTaskActivity(): UserTaskActivity;
        get microflow(): microflows.IMicroflow | null;
    ...
    class MicroflowCallParameterMapping extends internal.Element<IModel> {
         ...
         *  9.0.2 to 11.8.0
         */
        static createInCallMicroflowTaskUnderParameterMappings(container: CallMicroflowTask): MicroflowCallParameterMapping;
        /**
         * Creates and returns a new MicroflowCallParameterMapping instance in the SDK and on the server.
         * The new MicroflowCallParameterMapping will be automatically stored in the 'parameterMappings' property
         * of the parent MicroflowBasedActivity element passed as argument.
         ...
         *  11.9.0 and higher
         */
        static createInMicroflowBasedActivityUnderParameterMappings(container: MicroflowBasedActivity): MicroflowCallParameterMapping;
        /**
         * Creates and returns a new MicroflowCallParameterMapping instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class MicroflowGroupTargeting extends MicroflowBasedTargeting {
         ...
         *  11.2.0 and higher
         */
        static createIn(container: UserTaskActivity): MicroflowGroupTargeting;
        /**
         * Creates and returns a new MicroflowGroupTargeting instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): MicroflowGroupTargeting;
    }
    /**
     * In version 11.2.0: introduced
     */
    class MicroflowUserTargeting extends MicroflowBasedTargeting {
         ...
         *  11.2.0 and higher
         */
        static createIn(container: UserTaskActivity): MicroflowUserTargeting;
        /**
         * Creates and returns a new MicroflowUserTargeting instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): MicroflowUserTargeting;
    }
    /**
    ...
    abstract class UserTaskActivity extends WorkflowActivity implements IUserTaskActivity {
         ...
         * In version 11.2.0: introduced
         */
        get userTargeting(): UserTargeting;
        set userTargeting(newValue: UserTargeting);
    ...
    class MultiUserTaskActivity extends UserTaskActivity implements IMultiUserTaskActivity {
         ...
         *  10.12.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): MultiUserTaskActivity;
        /**
         * Creates and returns a new MultiUserTaskActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): MultiUserTaskActivity;
        /**
         * Creates and returns a new MultiUserTaskActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class NoUserTargeting extends UserTargeting {
         ...
         *  11.2.0 and higher
         */
        static createIn(container: UserTaskActivity): NoUserTargeting;
        /**
         * Creates and returns a new NoUserTargeting instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): NoUserTargeting;
    }
    /**
     * In version 11.8.0: introduced
     */
    interface INonInterruptingNotificationEventSubProcessStartActivity extends IWorkflowActivity {
        readonly model: IModel;
        readonly containerAsFlow: IFlow;
        asLoaded(): NonInterruptingNotificationEventSubProcessStartActivity;
        load(callback: (element: NonInterruptingNotificationEventSubProcessStartActivity) => void, forceRefresh?: boolean): void;
        load(forceRefresh?: boolean): Promise<NonInterruptingNotificationEventSubProcessStartActivity>;
    }
    /**
     * In version 11.8.0: introduced
     */
    class NonInterruptingNotificationEventSubProcessStartActivity extends WorkflowActivity implements INonInterruptingNotificationEventSubProcessStartActivity {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsFlow(): Flow;
        get containerAsWorkflowMetaData(): WorkflowMetaData;
         ...
         *  11.8.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): NonInterruptingNotificationEventSubProcessStartActivity;
        /**
         * Creates and returns a new NonInterruptingNotificationEventSubProcessStartActivity instance in the SDK and on the server.
         ...
         *  11.8.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): NonInterruptingNotificationEventSubProcessStartActivity;
        /**
         * Creates and returns a new NonInterruptingNotificationEventSubProcessStartActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): NonInterruptingNotificationEventSubProcessStartActivity;
    }
    /**
     * In version 11.7.0: introduced
     */
    abstract class NotifyTarget extends internal.Element<IModel> {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsNotifyWorkflowAction(): microflows.NotifyWorkflowAction;
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
    }
    /**
     * In version 11.8.0: introduced
    ...
    class NonInterruptingNotificationEventSubProcessStartActivityTarget extends NotifyTarget {
        ...
        static versionInfo: StructureVersionInfo;
        get containerAsNotifyWorkflowAction(): microflows.NotifyWorkflowAction;
        get activity(): INonInterruptingNotificationEventSubProcessStartActivity;
        set activity(newValue: INonInterruptingNotificationEventSubProcessStartActivity);
        get activityQualifiedName(): string;
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
        /**
         ...
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): NonInterruptingNotificationEventSubProcessStartActivityTarget;
    }
    /**
     * In version 10.20.0: introduced
     */
    ...
    class NonInterruptingTimerBoundaryEvent extends BoundaryEvent implements INonInterruptingTimerBoundaryEvent {
         ...
         *  11.9.0 and higher
         */
        static createInMicroflowBasedActivityUnderBoundaryEvents(container: MicroflowBasedActivity): NonInterruptingTimerBoundaryEvent;
        /**
         * Creates and returns a new NonInterruptingTimerBoundaryEvent instance in the SDK and on the server.
         * The new NonInterruptingTimerBoundaryEvent will be automatically stored in the 'boundaryEvents' property
         * of the parent UserTaskActivity element passed as argument.
    ...
    class NotifyWaitForNotificationActivityTarget extends NotifyTarget {
        ...
        static versionInfo: StructureVersionInfo;
        get containerAsNotifyWorkflowAction(): microflows.NotifyWorkflowAction;
        get activity(): IWaitForNotificationActivity;
        set activity(newValue: IWaitForNotificationActivity);
        get activityQualifiedName(): string;
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
        /**
         ...
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): NotifyWaitForNotificationActivityTarget;
    }
    /**
     * In version 11.1.0: introduced
     */
    class OrthogonalPath extends Line {
         ...
         *  11.1.0 and higher
         */
        static createIn(container: FlowLine): OrthogonalPath;
        /**
         * Creates and returns a new OrthogonalPath instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class ParallelSplitActivity extends WorkflowActivity implements IParallelSplitActivity {
         ...
         *  9.0.2 and higher
         */
        static createInFlowUnderActivities(container: Flow): ParallelSplitActivity;
        /**
         * Creates and returns a new ParallelSplitActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): ParallelSplitActivity;
        /**
         * Creates and returns a new ParallelSplitActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class SingleUserTaskActivity extends UserTaskActivity implements ISingleUserTaskActivity {
         ...
         *  10.12.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): SingleUserTaskActivity;
        /**
         * Creates and returns a new SingleUserTaskActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): SingleUserTaskActivity;
        /**
         * Creates and returns a new SingleUserTaskActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class StartWorkflowActivity extends WorkflowActivity implements IStartWorkflowActivity {
         ...
         *  11.1.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): StartWorkflowActivity;
        /**
         * Creates and returns a new StartWorkflowActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): StartWorkflowActivity;
        /**
         * Creates and returns a new StartWorkflowActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class StringCase extends CaseValue {
         ...
         *  11.5.0 and higher
         */
        static createIn(container: FlowLine): StringCase;
        /**
         * Creates and returns a new StringCase instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): StringCase;
    }
    /**
     * In version 10.0.0: introduced
     */
    ...
    class VoidCase extends CaseValue {
         ...
         *  11.5.0 and higher
         */
        static createIn(container: FlowLine): VoidCase;
        /**
         * Creates and returns a new VoidCase instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): VoidCase;
    }
    /**
     * In version 9.0.5: removed experimental
     * In version 9.0.2: introduced
    ...
    class WaitForNotificationActivity extends WorkflowActivity implements IWaitForNotificationActivity {
         ...
         *  10.0.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): WaitForNotificationActivity;
        /**
         * Creates and returns a new WaitForNotificationActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): WaitForNotificationActivity;
        /**
         * Creates and returns a new WaitForNotificationActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class WaitForTimerActivity extends WorkflowActivity implements IWaitForTimerActivity {
         ...
         *  10.6.0 and higher
         */
        static createInFlowUnderActivities(container: Flow): WaitForTimerActivity;
        /**
         * Creates and returns a new WaitForTimerActivity instance in the SDK and on the server.
         ...
         *  11.1.0 and higher
         */
        static createInWorkflowMetaDataUnderDetachedActivities(container: WorkflowMetaData): WaitForTimerActivity;
        /**
         * Creates and returns a new WaitForTimerActivity instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class Workflow extends projects.Document implements IWorkflow {
         ...
         * In version 11.8.0: introduced
         */
        get eventSubProcesses(): internal.IList<EventSubProcess>;
        /**
         * In version 9.15.0: introduced
         */
        get annotation(): Annotation | null;
         ...
         * In version 11.1.0: introduced
         */
        get workflowMetaData(): WorkflowMetaData | null;
        set workflowMetaData(newValue: WorkflowMetaData | null);
        /**
         * In version 11.1.0: introduced
         */
        get workflowV2(): boolean;
        set workflowV2(newValue: boolean);
     ...
     * In version 11.1.0: introduced
     */
    class WorkflowMetaData extends internal.Element<IModel> {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsWorkflow(): Workflow;
        get detachedActivities(): internal.IList<WorkflowActivity>;
        get flowLines(): internal.IList<FlowLine>;
        get annotation(): internal.IList<FloatingAnnotation>;
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
        /**
         ...
         *  11.1.0 and higher
         */
        static createIn(container: Workflow): WorkflowMetaData;
        /**
         * Creates and returns a new WorkflowMetaData instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): WorkflowMetaData;
    }
    /**
     * In version 9.10.0: deleted
     * In version 9.7.0: introduced
     ...
     * In version 11.2.0: introduced
     */
    abstract class XPathBasedTargeting extends UserTargeting {
        static structureTypeName: string;
        static versionInfo: StructureVersionInfo;
        get containerAsUserTaskActivity(): UserTaskActivity;
        /**
    ...
    class XPathGroupTargeting extends XPathBasedTargeting {
         ...
         *  11.2.0 and higher
         */
        static createIn(container: UserTaskActivity): XPathGroupTargeting;
        /**
         * Creates and returns a new XPathGroupTargeting instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): XPathGroupTargeting;
    }
    /**
     * In version 11.2.0: introduced
     */
    class XPathUserTargeting extends XPathBasedTargeting {
         ...
         *  11.2.0 and higher
         */
        static createIn(container: UserTaskActivity): XPathUserTargeting;
        /**
         * Creates and returns a new XPathUserTargeting instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
         */
        static create(model: IModel): XPathUserTargeting;
    }
}
